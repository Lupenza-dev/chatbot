                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th scope="col">Response Linked To</th>
                                            <th>Message Type</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="margin-top: 20px; margin-bottom: 20px">
                                            ...
                                            <td>{{ $link->message_type }}</td>
                                            <td>
                                                <a href="{{ route('threads.edit',$link->uuid )}}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="registration_form">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <label for="">Message Response To Link</label>
                           <select name="linked_message_id" class="form-control">
                            <option value="" selected> Select Response To Linked</option>
                            @foreach ($messages as $item)
                                <option value="{{ $item->id }}">{{ $item->title_eng }}</option>
                            @endforeach
                           </select>
