            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Thread</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-12 col-md-12 text-center">
                                    ...
                                    <button type="button" class="btn btn-outline-dark"> <span class="bx bx-reset"></span> Cancel</button>
                                    </a>
                                    <button type="submit" class="btn btn-success" id="reg_btn">  <span class="bx bx-refresh"></span> Update</button>
                                </div>
